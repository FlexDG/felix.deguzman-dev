...
const SOCIALS = [
  {
    label: 'Facebook',
    href: 'https://www.facebook.com/FlexDG05/',
    target: '_blank',
  ...
  {
    label: 'LinkedIn',
    href: 'https://www.linkedin.com/in/felix-de-guzman/',
    target: '_blank',
    rel: 'noopener noreferrer',
  ...
  {
    label: 'Instagram',
    href: 'https://www.instagram.com/flexdg.ui/?hl=en',
    target: '_blank',
    rel: 'noopener noreferrer',
  ...
  {
    label: 'Twitter',
    href: 'https://x.com/Felixiiiiible',
    target: '_blank',
    rel: 'noopener noreferrer',
